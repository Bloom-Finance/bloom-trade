        ...
        <Drawer anchor='bottom' open={showWalletInfo}>
          <Stack p={2}>
            <Typography variant='body1' py={3}>
              To starting collect payments we need that you define where you
              want to receive payments. We need information about your wallet
              address, chain and coin of your preference
            </Typography>
            <WalletInfo
        ...
        >
          ...
          <Box>
            <Button
              ...
              startIcon={<Iconify icon={'mdi:wallet-add-outline'} />}
            >
              Add
            </Button>
          </Box>
